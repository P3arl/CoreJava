...
public class BrokerChainSample {
    ...
    public static void main(String[] args) {
        ...
        IncreaseDefenseModifier defenseModifier = new IncreaseDefenseModifier(game, goblin);
        final DoubleAttackModifier attackModifier = new DoubleAttackModifier(game, goblin);
        try(attackModifier) {
            System.out.println(goblin);
        }
        System.out.println(goblin);
...
class Event<Args> {
    ...
    public void unsubsribe(int key) {
        handlers.remove(key);
    }
